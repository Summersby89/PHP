...
$typeImg = ['image/jpeg', 'image/png', 'image/gif', 'image/jpg',];
$typeImgImplode = implode(", ", $typeImg);
    ...
    <div class="form-wrapper">
      <form class="row g-3" id="form">
        <div class="mb-3">
          ...
          <input class="form-control" type="file" name="images[]" id="photo" multiple accept="<?= $typeImgImplode ?>">
